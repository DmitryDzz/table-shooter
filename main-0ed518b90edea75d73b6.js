...
/***/ "./src/babylon/ArcRotateCameraWorkerInput.ts":
/*!***************************************************!*\
  !*** ./src/babylon/ArcRotateCameraWorkerInput.ts ***!
  \***************************************************/
...
class ArcRotateCameraWorkerInput {
    ...
    _maxBetaSpeed;
    _engine = null;
    cameraRotationSpeedFactors = { alpha: 0, beta: 0 };
    camera;
    /**
     * Constructor.
     ...
     */
    constructor(maxAlphaSpeed, maxBetaSpeed) {
...
/* harmony export */ });
class Env {
    static meters2units = 0.02;
    static units2meters = 1 / Env.meters2units;
    static camera = {
        near: 0.2,
        far: 10000,
...
/* harmony import */ var _ArcRotateCameraWorkerInput__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ArcRotateCameraWorkerInput */ "./src/babylon/ArcRotateCameraWorkerInput.ts");
...
class GameScene extends _babylonjs_core__WEBPACK_IMPORTED_MODULE_0__.Scene {
    ...
    constructor(engine, canvas, options) {
        ...
        this.rootNode.scaling = _babylonjs_core__WEBPACK_IMPORTED_MODULE_0__.Vector3.One().scale(_env__WEBPACK_IMPORTED_MODULE_1__.Env.meters2units);
        this.cameraParentNode = new _babylonjs_core__WEBPACK_IMPORTED_MODULE_0__.TransformNode("cameraParentNode", this);
        this.cameraParentNode.parent = this.rootNode;
        this.cameraParentNode.position = _babylonjs_core__WEBPACK_IMPORTED_MODULE_0__.Vector3.Zero();
        const deg2rad = (deg) => { return deg * Math.PI / 180; };
        this.camera = new _babylonjs_core__WEBPACK_IMPORTED_MODULE_0__.ArcRotateCamera("camera", deg2rad(-90), deg2rad(60), 36, _babylonjs_core__WEBPACK_IMPORTED_MODULE_0__.Vector3.Zero(), this, true);
...
class Level1 extends _gameScene__WEBPACK_IMPORTED_MODULE_1__.GameScene {
    ...
    async initializeAsync() {
        ...
        ground.position = (0,_math__WEBPACK_IMPORTED_MODULE_2__.createVector3)({ x: 0, y: 0, z: 0 });
        ...
        homeYard.position = (0,_math__WEBPACK_IMPORTED_MODULE_2__.createVector3)({ x: -8, y: 0, z: 0 });
        ...
        barn.position = (0,_math__WEBPACK_IMPORTED_MODULE_2__.createVector3)({ x: 10, y: 0, z: 0 });
        ...
        streetlight.position = (0,_math__WEBPACK_IMPORTED_MODULE_2__.createVector3)({ x: 1, y: 0, z: -3 });
...
/* harmony import */ var _env__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./env */ "./src/babylon/env.ts");
...
class Player {
    _scene;
    _mesh;
    _scaling = _env__WEBPACK_IMPORTED_MODULE_3__.Env.meters2units;
    _position = (0,_math__WEBPACK_IMPORTED_MODULE_1__.createVector3)({ x: 0, y: 8.25, z: -10 });
    constructor(scene) {
        this._scene = scene;
    }
    async initializeAsync() {
    ...
    setGamepadState({ moveVector, lookVector, bumperPressed }, cameraDirection) {
        ...
        if (isFacing)
            ...
            faceVector = mv.clone();
        if (faceVector !== null) {
            const faceQuaternion = _babylonjs_core__WEBPACK_IMPORTED_MODULE_0__.Quaternion.FromLookDirectionLH(faceVector, _babylonjs_core__WEBPACK_IMPORTED_MODULE_0__.Vector3.Up());
...
module.exports = "assets/48406d8fa1350aa1f3b4.glb";
